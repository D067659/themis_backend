...
module.exports.sendConfirmationEmail = (senderName, senderClubId, senderClubName, receiverName, receiverEmail, confirmationCode) => {
  transport.sendMail({
    ...
    html: `<h1>Bitte bestätige deine Registrierung</h1>
          ...
          <p>du hast soeben eine Einladung in den Verein ${senderClubName} von ${senderName} erhalten. Bitte bestätige, dass du dem Verein beitreten möchtest, indem du auf den folgenden Link klickst:</p>
